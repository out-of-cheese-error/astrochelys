...
* Layout
The layout is something all pages will have in common so we set it up in base.html. This is easy enough to set up with PureCSS.
In base.html:
#+BEGIN_SRC html :tangle templates/base.html
    <body>
