...
+ 26 December 2020
  + Link backgrounds
  + Better sidebar padding to allow for light or dark sidebars.
+ 23 August 2020 
...
#+END_EXPORT
** Links
Hyperlinks are a nice place to add some pizzazz - a color for the text that changes and becomes underlined when you hover, and a light background to make it stand out.
#+BEGIN_SRC css :tangle "static/css/astrochelys.css"
a {
