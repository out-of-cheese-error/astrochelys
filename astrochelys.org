...
* Edits
+ 27 December 2020
  Simplified colors and switched to Tomorrow theme. Added sidebar color, link backgrounds, code block borders.
+ 23 August 2020 
...
#+BEGIN_SRC css :tangle "static/css/astrochelys.css"
 :root {
  --main-color: #8959a8; /* the .k (keyword) color  */ 
  --bg-color-main: #fff; /* overall background */
  --secondary-color: #4d4d4c; /* the .n (name) color  */
  --bg-color-secondary: #4d4d4c20; /* same as secondary-color but with lower opacity, background for certain elements */
  --text-color: #1d1f21; /* nearly black */
}
#+END_SRC
#+BEGIN_EXPORT html
  </details>
