...
4. *Add the following options to ~pelicanconf.py~.* (the table of contents can be customized as described [[https://github.com/ingwinlu/pelican-toc This can be customized as described [[https://github.com/ingwinlu/pelican-toc#settings][here]])
#+BEGIN_SRC python
TAG_SAVE_AS = ''
AUTHOR_SAVE_AS = ''
CATEGORY_SAVE_AS = ''
